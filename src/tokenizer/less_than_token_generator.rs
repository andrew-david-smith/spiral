pub struct LessThanTokenGenerator {}

impl super::token_generator::TokenGenerator for LessThanTokenGenerator {
    ...
    fn generate(
        ...
        if char.is_none() {
            return Ok(super::Token {
                value,
                token_type: super::TokenType::LessThan,
                begin: begin_index,
        ...
        if unwrapped_char == '=' {
            ...
            Ok(super::Token {
                value,
                token_type: super::TokenType::LessThanEquals,
                begin: begin_index,
                end: tokenizer.current_index,
                line_number: tokenizer.line_number,
                line: tokenizer.current_line(),
            ...
            Ok(super::Token {
                value,
                token_type: super::TokenType::LeftArrow,
                begin: begin_index,
                end: tokenizer.current_index,
                line_number: tokenizer.line_number,
                line: tokenizer.current_line(),
